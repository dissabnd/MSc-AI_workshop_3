# Water Treatment & Cooling — Capstone Group Brief

**Process area:** Water Treatment & Cooling
...
Cooling water return temperature from condenser C-201 has been running at 44°C. This morning's boiler feed water sample read 2.5 ppm hardness. Cooling tower conductivity is drifting outside the dosing-plan band. None of these is a declared emergency on its own — but each has a knock-on effect somewhere else in the plant (D-201's top pressure, the boiler, or discharge quality) that the shift team needs to reason through before deciding whether, and what, to touch.

## Your knowledge document(s)

- `knowledge/Water_Treatment_Cooling_SOP.pdf` (SOP-WTR-022)
