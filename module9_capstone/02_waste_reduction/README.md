# Waste Reduction — Capstone Group Brief

**Process area:** Waste Reduction
...
A batch of stillage has just come off D-201 with bottoms temperature at 110°C. At the same time, off-spec distillate from an earlier upset is sitting at 78% v/v EtOH, and it's not obvious whether either stream can be routed normally or needs sign-off first. On top of that, the shift supervisor wants a straight answer: what's the single biggest lever for cutting how much slops this line generates?

## Your knowledge document(s)

- `knowledge/Waste_ByProduct_Handling_SOP.pdf` (SOP-WST-045)
