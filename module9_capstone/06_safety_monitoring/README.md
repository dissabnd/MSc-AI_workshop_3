# Safety Monitoring — Capstone Group Brief

**Process area:** Safety Monitoring
...
Ethanol has splashed on an operator's skin during a sampling round. Elsewhere on site, a small ethanol fire has started near a drum. Your group's agent needs to be the thing an operator reaches for in exactly these moments — where the SDS in front of them is dense and the first 60 seconds matter more than a perfect citation.

## Your knowledge document(s)

- `knowledge/SDS_Ethanol.pdf`
