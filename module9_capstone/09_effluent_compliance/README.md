# Effluent Compliance — Capstone Group Brief

**Process area:** Effluent Compliance
...
This week's BOD sample from the W-301 discharge came back at 28 mg/L. Discharge pH read 6.2 this morning. Yesterday there was an off-spec stillage event upstream, and now someone is asking whether that needs cross-checking against today's effluent sample. None of this is unambiguously a breach on its own — but the compliance clock doesn't wait for someone to work that out.

## Your knowledge document(s)

- `knowledge/Effluent_Discharge_Compliance_Standard.pdf` (STD-ENV-018)
