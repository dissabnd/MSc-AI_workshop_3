# Energy Optimization — Capstone Group Brief

**Process area:** Energy Optimization
...
You're midway through a shift on the D-201 distillation train. Steam consumption has crept up to 3.3 kg per litre of distillate — above the 2.6 target. Reflux ratio has been sitting at 3.6 for the last two shifts. Nothing has tripped and no safety alarm has fired — this is purely an efficiency question: is this an energy-loss pattern worth escalating, and what should the shift team check before it quietly becomes tomorrow's problem too?

## Your knowledge document(s)

- `knowledge/Energy_Utility_Consumption_Standard.pdf` (STD-ENG-030)
